/* **********************************************
 * 												*
 * 	Moving platform controller with raycast2D	*
 * 												*
 * 	with multi(2+) waypoint system				*
 *	diagonal movements are possible				*
 * 	
 *	!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	*
 * 	ignore collision mask						*
 * 	setting passenger mask is required			*
 * 												*
 * **********************************************/
...
namespace RayCastController2D
{
	public class MovingPlatformerController2D : Raycast2D
	{
		...
		Dictionary<Transform, CollisionController2D> passengerDictonary = new Dictionary<Transform, CollisionController2D> ();
		...
		private void MovePassengers (bool beforeMovePlatform)
		{
			...
			foreach (PassengerMovement passenger in passengerMovement) {
				...
				if (!passengerDictonary.ContainsKey (passenger.transform)) {
					passengerDictonary.Add (passenger.transform, passenger.transform.GetComponent<CollisionController2D> ());
				}
